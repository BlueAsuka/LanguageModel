...
n = int(train_val_ratio * len(data)) # first 90% will be train, rest val
train_data = data[:n]
val_data = data[n:]
...
# Define validation function and parameters
...
print(decode(model.generate(start_token, max_new_tokens=300)[0].tolist()))
